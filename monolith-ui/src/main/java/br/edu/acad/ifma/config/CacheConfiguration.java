...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, br.edu.acad.ifma.model.User.class.getName());
            createCache(cm, br.edu.acad.ifma.model.Authority.class.getName());
            createCache(cm, br.edu.acad.ifma.model.User.class.getName() + ".authorities");
